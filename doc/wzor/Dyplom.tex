...
%%  Metadane dokumentu 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{System wizualizacji działania algorytmów sztucznej inteligencji do zagadnień sterowania obiektami symulowanymi w środowisku Unity}
\titleShort{Szablon pracy dyplomowej ...}
\titleEN{A system for visualization of performance of Artificial Intelligence algorithms applied for control of objects simulated in the Unity environment}
\author{Jakub Pawłowski}
\uczelnia{POLITECHNIKA WROCŁAWSKA}
\wydzial{WYDZIAŁ ELEKTRONIKI}
\kierunek{AUTOMATYKA I ROBOTYKA}
\specjalnosc{TECHNOLOGIE INFORMATYCZNE W SYSTEMACH AUTOMATYKI}
\promotor{dr., Marek Bazan, Katedra Informatyki Technicznej}
\date{WROCŁAW, 2019}
